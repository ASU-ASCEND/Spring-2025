 ...
 */
SHTC3Sensor::SHTC3Sensor(unsigned long minimum_period) : Sensor("SHTC3", "Temp(C), Humidity(%)", 2, minimum_period) {}
...
void SHTC3Sensor::readDataPacket(uint8_t*& packet){
    ...
    memcpy(packet, &(humidity.relative_humidity), sizeof(humidity.relative_humidity));
