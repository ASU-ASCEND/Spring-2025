...
/**
 * @brief Construct a new TMP117Sensor object with default minimum_period of 0 ms.
 * 
 */
 ...
 */
TMP117Sensor::TMP117Sensor(unsigned long minimum_period) : Sensor ("TMP117", "TMP117Temp(C)", 1, minimum_period) {}
...
/**
 * @brief Reads sensor data (Temp (C)) and appends to the passed uint8_t array pointer, incrementing it.
 * 
